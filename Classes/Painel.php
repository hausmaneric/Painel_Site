<?php
   class Painel
   {
        ...
        // Carregamento das paginas de forma inteligente
        ...
        // Listar o número de usuarios online
        ...
        // Limpar número de usuarios online
        ...
        // Verificar o tamanho e o formato da imagem
        ...
        // Carregar e salvar a nova imagem
        ...
        // Deleter imagem na pasta depois de atualizar
        ...
        public static function insert($arr){
            ...
            $query = "INSERT INTO `$nome_tabela` VALUE (null";
            ...
            if($certo == true){
                ...
                $sql->execute(array(MySql::conectar()->lastInsertId()));
            }
            return $certo;
        }
        ...
        public static function selectAll($tabela,$start = null,$end = null){
            if($start == null && $end == null){
                ...
                $sql = MySql::conectar()->prepare("SELECT * FROM `$tabela` ORDER BY order_id ASC LIMIT $start,$end"); // ORDER BY id DESC
            }
            $sql->execute();
            return $sql->fetchAll();
        }
